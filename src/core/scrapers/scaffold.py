...
from core.scrapers.registry import RESERVED_PLUGIN_NAMES, SNAKE_CASE_KEY
from core.scrapers.url import normalize_domain
...
def create_plugin(repo_root: Path, request: ScaffoldRequest) -> tuple[Path, Path]:
    ...
    source = repo_root / "src" / "core" / "scrapers" / request.target
