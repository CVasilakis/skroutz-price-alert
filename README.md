...
| `last_reminder` | String | *Internal* | Auto-generated by the script. Do not modify. Local-time timestamp of the last successfully delivered reminder's scheduled slot (not the actual send time). |
